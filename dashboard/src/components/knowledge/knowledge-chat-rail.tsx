...
function SendIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" width={20} height={20} fill="none" stroke="currentColor" strokeWidth={2.2}>
      <path d="M4 12l16-7-4 7 4 7-16-7z" strokeLinejoin="round" />
    </svg>
  );
}
